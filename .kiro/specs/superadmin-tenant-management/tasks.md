...
- [x] 1. Extend data model and create authorization middleware
  - [x] 1.1 Extend AccountRole enum in schema and add superadmin authorization guard
...
- [x] 2. Implement superadmin tenant server logic
  - [x] 2.1 Create tenant list query logic
  ...
  - [x] 2.2 Create tenant detail query logic
  ...
  - [x] 2.3 Create tenant creation logic
  ...
  - [x] 2.4 Create tenant status update logic
...
- [x] 3. Implement API route handlers
  - [x] 3.1 Create `GET /api/superadmin/tenants` route
  ...
  - [x] 3.2 Create `POST /api/superadmin/tenants` route
  ...
  - [x] 3.3 Create `GET /api/superadmin/tenants/$id` route
  ...
  - [x] 3.4 Create `PATCH /api/superadmin/tenants/$id/status` route
...
- [x] 5. Implement SuperadminLayout component
  - [x] 5.1 Create the SuperadminLayout component
...
- [x] 6. Implement TenantListPanel component
  - [x] 6.1 Create the TenantListPanel component
...
- [x] 7. Implement TenantDetailPanel component
  - [x] 7.1 Create the TenantDetailPanel component
...
- [x] 8. Implement TenantCreateDialog component
  - [x] 8.1 Create the TenantCreateDialog component
...
- [x] 9. Implement SuperadminSection orchestrator and route
  - [x] 9.1 Create the SuperadminSection component
  ...
  - [x] 9.2 Create the `/superadmin` route file
