...
import { Server, HardDrive, DoorOpen, MonitorSmartphone, BookOpen, Settings } from 'lucide-react'
      ...
      return (
        <AuthLayout variant="brand-dark">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div>
                ...
                <p className="type-body2 text-muted-foreground">Mencatat waktu masuk ke kartu anggota</p>
              </div>
            </button>
            ...
            >
              ...
              <div>
                ...
                <p className="type-body2 text-muted-foreground">Menghitung durasi dan memotong saldo anggota</p>
              </div>
            </button>
            ...
            >
              ...
              <div>
                ...
                <p className="type-body2 text-muted-foreground">Anggota melihat saldo dan riwayat kartu</p>
              </div>
            </button>
          </div>
          ...
          <Button
            type="button"
            variant="outline"
            onClick={() => { setSetupStep('auth'); setPendingContext(null) }}
            className="w-full"
          >
            Kembali
          </Button>
      ...
      <AuthLayout variant="brand-dark">
        ...
        <form onSubmit={handleDeviceSetupAuth} className="space-y-4">
          <div className="space-y-1.5">
            <Label htmlFor="setup-username" className="type-body1-bold">Username Admin</Label>
            <Input
              id="setup-username"
              type="text"
              value={username}
          ...
          <div className="space-y-1.5">
            <Label htmlFor="setup-password" className="type-body1-bold">Password</Label>
            <Input
              id="setup-password"
              type="password"
              value={password}
