...
import { makeFreshCard } from "#/presentation/components/section/IssuanceTestSection";
import { prepareWrite, encodePayloadWire } from "#/presentation/hooks/domain";
import type { SessionGrant } from "#/presentation/hooks/types";
import { API_BASE_URL, apiFetch } from "#/presentation/hooks/useApi";
