...
import { useBlockedCheck } from "#/presentation/hooks/useBlockedCheck";
import { useKioskAutoScan } from "#/presentation/hooks/useKioskAutoScan";
import { useSyncEngineContext } from "#/presentation/hooks/SyncEngineContext";
import { validateTransition, applyCheckin, applyBlockStatus } from "#/presentation/hooks/domain";
import { CardState, CardStatus } from "#/presentation/hooks/types";
import { notifyCheckin } from "#/presentation/hooks/usePeerSync";
import { updateLocalCardRecord } from "#/presentation/hooks/nfc/updateLocalCardRecord";
...
import type { BlockedCheckResult } from "#/presentation/hooks/useBlockedCheck";
