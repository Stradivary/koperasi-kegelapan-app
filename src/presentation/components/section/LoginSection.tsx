...
} from "#/presentation/hooks/useServerTenantSearch";
import { LoadingState } from "../block/LoadingState";
import { useOnlineStatus } from "#/presentation/hooks/useOnlineStatus";
import { useLoginFlow } from "#/presentation/hooks/useLoginFlow";
import { useLoginAuth } from "#/presentation/hooks/useLoginAuth";
  ...
  if (flow.mode === "scout-browse") {
    return (
      <ScoutBrowsePanel
        ...
        loading={scoutTenantLoading}
        error={scoutTenantError}
        slugError={flow.slugNotFoundError}
        isOnline={isOnline}
        ...
        onEnterSlug={(slug) => {
          void flow.handleScoutEnterSlug(slug, isOnline);
        }}
        onBack={() => {
          flow.enterLogin();
        }}
