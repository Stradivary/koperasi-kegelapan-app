...
import { setCurrentDeviceId, restoreAuthState, API_BASE_URL } from "#/infrastructure/api/apiClient";
...
import { hydrateQueryCache } from "#/presentation/hooks/useHydrateCache";
import type { PendingDeviceContext } from "#/presentation/hooks/useLoginAuth";

// ── Re-export PendingDeviceContext so consumers can import from one place ─────
export type { PendingDeviceContext } from "#/presentation/hooks/useLoginAuth";
